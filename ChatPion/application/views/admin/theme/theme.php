...
<html lang="en">
    ...
    if(
        $is_mobile=='0' && ( 
          ...
          ($controller_name=="livechat" && ($function_name=="load_livechat")) ||
	...
	<audio id="chatNotificationAudio" class="d-none"><source src="<?php echo base_url('assets/images/media/notification-tone.mp3');?>" type="audio/mp3"></audio>
	<audio id="agentAssignNotificationAudio" class="d-none"><source src="<?php echo base_url('assets/images/media/agentAssigned-notification.mp3');?>" type="audio/mp3"></audio>
	  <div id="app">
	    <div class="main-wrapper">
			...
			echo '<div class="main-content '.$main_content_class.'">';
				$this->load->view($body);
			echo '</div>';
			include(FCPATH.'application/views/include/pusher-js.php');
			if(current_url() != base_url('livechat/load_livechat'))
