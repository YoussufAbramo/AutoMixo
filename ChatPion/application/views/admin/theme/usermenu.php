<li class="dropdown" id="xxx"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
  ...
  <div class="d-none d-md-inline-block"><?php echo $this->is_manager!==1 ? $this->session->userdata('username') : $this->session->userdata('username')." (".$this->session->userdata('team_username').")"; ?></div></a>
