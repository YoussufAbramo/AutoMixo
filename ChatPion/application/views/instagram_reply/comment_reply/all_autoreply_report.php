                        ...
                        <div class="row" id="edit_delete_offensive_comment_keyword_div">
                            ...
                            <div class="col-12 col-md-6">
                                <div class="form-group clearfix e4e6fc_border_dashed">
                                    ...
                                    <div>                      
                                        <select class="form-group private_reply_postback select2" style="width:100% !important;" id="edit_private_message_offensive_words" name="edit_private_message_offensive_words">
                    ...
                    <div class="row padding_10_20_10_20px">
                        ...
                        <div class="col-12 d_none" id="edit_generic_message_div">
                            <div class="form-group e4e6fc_border_dashed clearfix">
                                ...
                                <div>                      
                                  <select class="form-group private_reply_postback select2" style="width:100% !important;" id="edit_generic_message_private" name="edit_generic_message_private">
                                    <option><?php echo $this->lang->line('Please select a page first to see the message templates.'); ?></option>
                                  </select>
                        ...
                        <div class="col-12 d_none" id="edit_filter_message_div">
                            ...
                            <?php for ($i = 1; $i <= 20; $i++) : ?>
                                <div class="form-group instagram_border_margined_padded2 clearfix" id="edit_filter_div_<?php echo $i; ?>">
                                    ...
                                    <div>                      
                                      <select class="form-group private_reply_postback select2" style="width:100% !important;" id="edit_filter_message_<?php echo $i; ?>" name="edit_filter_message_<?php echo $i; ?>">
                                        <option><?php echo $this->lang->line('Please select a page first to see the message templates.'); ?></option>
                                      </select>
                            ...
                            <div class="form-group instagram_border_margined_padded clearfix" id="edit_nofilter_word_found_div">
                                ...
                                <div>                      
                                  <select class="form-group private_reply_postback select2" style="width:100% !important;" id="edit_nofilter_word_found_text_private" name="edit_nofilter_word_found_text_private">
                                    <option><?php echo $this->lang->line('Please select a page first to see the message templates.'); ?></option>
                                  </select>
