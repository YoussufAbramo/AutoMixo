...
<section class="section section_custom">
  <div class="section-header">
    ...
    <div class="section-header-button">
      <a class="btn btn-primary variables" href="#"><i class="fas fa-plus-circle"></i> <?php echo $this->lang->line('Variables'); ?></a>
    </div>
    <?php endif; ?>

    <div class="section-header-breadcrumb">
       <div class="breadcrumb-item"><a href="<?php echo base_url('messenger_bot'); ?>"><?php echo $this->lang->line("Messenger Bot"); ?></a></div>
      <div class="breadcrumb-item"><a href="<?php echo base_url('messenger_bot/template_manager')."?media_type={$media_type}"; ?>"><?php echo $this->lang->line('Post-back Manager'); ?></a></div>
        ...
        <div class="<?php if($is_iframe=="1") echo 'col-12'; else echo 'col-12 col-lg-9';?>">
            ...
            <div class="row"> 
              ...
              <div class="col-12 col-sm-6">
                <div class="form-group">
                  ...
                  <a class="btn btn-outline-primary variables form-control" href="#"><i class="fas fa-plus-circle"></i> <?php echo $this->lang->line('Variables'); ?></a>
                </div>
              </div>
              <?php endif; ?>
          ...
          <!--   This div is added by Konok to make it sortable  -->
            ...
            <div class="row">
              ...
              <?php if($iframe != '1') : ?>
              <div class="col-6">
                <a class="btn btn-lg btn-secondary float-right" href="<?php echo base_url("messenger_bot/template_manager")."?media_type={$media_type}"; ?>"><i class="fas fa-times"></i> <?php echo $this->lang->line('Back'); ?></a>
              </div>
              <?php endif; ?>
            </div>
...
<script type="text/javascript">
  $(document).ready(function(e){
    ...
    $(document).on('click','#create_label_postback',function(e){
      ...
      var social_media = $("#hidden_media_type").val();
...
<?php for($template_type=1;$template_type<=6;$template_type++){ ?>
  ...
  var template_type_order="#template_type_<?php echo $template_type ?>";
    ...
    $(document).on('change',"#template_type_<?php echo $template_type ?>",function(){
      ...
      // alert(multiple_template_add_button_counter);
  ...
  <?php } ?>
    ...
    $(document).on('click','#submit',function(e){   
      ...
      var template_postback_id = $("#template_postback_id").val().trim();
      ...
      $.ajax({
        context: this,
        type:'POST' ,
        url: base_url+"messenger_bot/create_template_action?media_type="+media_type,
        data: queryString,
        dataType : 'JSON',
        // async: false,
        cache: false,
        ...
        success:function(response){
          ...
          var link="<?php echo site_url('messenger_bot/template_manager').'?media_type='.$media_type; ?>";            
          if(is_iframe=='1') 
          {
