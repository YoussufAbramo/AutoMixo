 ...
 <div class="section-body">
 	<div class="row">
      ...
      <div class="wizard-steps mb-4 mt-1">
        <a href="<?php echo base_url("comment_automation/all_auto_comment_report/0/0/1?media_type=".$this->using_media_type); ?>" class="no_hover">
 		...
 		<div class="col-lg-3">
      <div class="wizard-steps mb-4 mt-1">
        <a href="<?php echo base_url("instagram_reply/instagram_autoreply_report/post?media_type=".$this->using_media_type); ?>" class="no_hover">
          <div class="wizard-step wizard-step-light">
 		...
 		<div class="col-lg-3">
      <div class="wizard-steps mb-4 mt-1">
        <a href="<?php echo base_url("instagram_reply/instagram_autoreply_report/full?media_type=".$this->using_media_type); ?>" class="no_hover">
          <div class="wizard-step wizard-step-light">
 		...
 		<div class="col-lg-3">
      <div class="wizard-steps mb-4 mt-1">
        <a href="<?php echo base_url("instagram_reply/instagram_autoreply_report/mention?media_type=".$this->using_media_type); ?>" class="no_hover">
          <div class="wizard-step wizard-step-light">
