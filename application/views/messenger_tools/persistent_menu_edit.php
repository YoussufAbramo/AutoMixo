...
<script type="text/javascript">
  ...
  $(document).on('click','#submit',function(e){   
      ...
      var queryString = new FormData($("#messenger_bot_form")[0]);
        $.ajax({
          type:'POST' ,
          url: base_url+"messenger_bot/edit_persistent_menu_action?media_type="+selected_global_media_type,
          data: queryString,
          dataType : 'JSON',
          // async: false,
          cache: false,
          ...
          success:function(response){
            ...
            if(response.status=='1')
              window.location.assign(base_url+"messenger_bot/persistent_menu_list/"+page_table_id+"/1?media_type"+selected_global_media_type);
            else 
            {
  ...
  $(document).ready(function(){
    ...
    $('#add_template_modal').on('hidden.bs.modal', function (e) { 
      ...
      var page_id="<?php echo $page_auto_id;?>";
       ...
       $.ajax({
         type:'POST' ,
         url: base_url+"messenger_bot/get_postback_for_persistent_menu?media_type="+selected_global_media_type,
      ...
      <div class="modal-body padding-0">
        <form id="messenger_bot_form">
          ...
          { ?>
                      ...
                      <div class="col-4 col-md-4">
                        <div class="form-group">
                          <select class="form-control text_with_button_type_class_level1" id="text_with_button_type_<?php echo $i; ?>" name="text_with_button_type_<?php echo $i; ?>">
                            ...
                            <option <?php if($level1_xtype=='web_url' || $level1_xtype=='nested') echo 'selected';?> value="web_url"><?php echo $this->lang->line("Web URL"); ?></option>
                            ...
                            <div class="col-4 col-md-4">
                              <div class="form-group">
                                <select class="form-control text_with_button_type_class_level2" id="text_with_button_type_<?php echo $i; ?>_<?php echo $j;?>" name="text_with_button_type_<?php echo $i; ?>_<?php echo $j;?>">
                                  <!-- <option value=""><?php echo $this->lang->line('please select a type'); ?></option> -->
                                  <option <?php if($level2_xtype=='web_url' || $level1_xtype=='nested') echo 'selected';?> value="web_url"><?php echo $this->lang->line("Web URL"); ?></option>
            ...
            <a href="#" style="border-radius: 0;" class="btn btn-sm btn-outline-primary float-right <?php if($text_with_button_counter_level1_js>=$level1) echo 'hidden';?>" id="add_more"><i class="fa fa-plus-circle"></i> <?php echo $this->lang->line("Add"); ?></a>
            ...
            <br><br>
             ...
             <div class="row">
              <div class="col-12">
                ...
                <a href="<?php echo base_url("messenger_bot/persistent_menu_list/$page_auto_id/1").'?media_type='.$media_type; ?>" class="btn btn-lg btn-secondary float-right"><i class="fa fa-close"></i> <?php echo $this->lang->line('Cancel'); ?></a>
                <br>
                <br>
