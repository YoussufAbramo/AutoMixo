         ...
         <div class="col-lg-6">
           <div class="card card-large-icons">
             ...
             <div class="card-body">
               ...
               <a href="<?php echo base_url("messenger_bot/bot_list").'?media_type=ig'; ?>" class="card-cta"><?php echo $this->lang->line("Actions"); ?> <i class="fas fa-chevron-right"></i></a>
             </div>
           </div>
         </div>
       ...
       <div class="col-lg-6">
         <div class="card card-large-icons">
           ...
           <div class="card-body">
             ...
             <a href="<?php echo base_url("messenger_bot/bot_list").'?media_type=fb'; ?>" class="card-cta"><?php echo $this->lang->line("Actions"); ?> <i class="fas fa-chevron-right"></i></a>
           </div>
         </div>
       </div>
