            ...
            <ul class="list-unstyled list-unstyled-border list-unstyled-noborder">
                ...
                { ?>
                  <li class="media">
                    ...
                    <?php if($single_reply['brand_logo']!=''|| !empty($single_reply['team_member_id'])) :?>
                    ...
                    <div class="media-body">
                      <div class="media-title mb-1">
                        <?php echo !empty($single_reply['team_member_id']) ? $single_reply['name']." (".$single_reply['team_member_name'].")" : $single_reply['name'];?>
